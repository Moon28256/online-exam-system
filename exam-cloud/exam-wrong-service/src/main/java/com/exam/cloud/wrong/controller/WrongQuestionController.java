package com.exam.cloud.wrong.controller;
...
public class WrongQuestionController {
    ...
    public Result<Boolean> submitBatch(@RequestBody WrongBatchDTO dto) {
        return Result.success(wrongQuestionService.submitBatch(dto));
    }
