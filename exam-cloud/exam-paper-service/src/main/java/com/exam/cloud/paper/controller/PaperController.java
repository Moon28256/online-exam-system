package com.exam.cloud.paper.controller;
...
public class PaperController {
    ...
    public Result<Paper> internalGet(@PathVariable Long id) {
        return Result.success(paperService.getById(id));
    }

    @GetMapping("/internal/{id}/paper-questions")
    public Result<List<PaperQuestion>> internalPaperQuestions(@PathVariable Long id) {
