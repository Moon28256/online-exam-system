package com.exam.cloud.user.controller;

import com.exam.cloud.common.api.Result;
import com.exam.cloud.common.dto.ChangePasswordDTO;
import com.exam.cloud.common.dto.LoginDTO;
import com.exam.cloud.common.dto.RegisterDTO;
import com.exam.cloud.common.dto.UpdateProfileDTO;
...
public class UserController {
    ...
    // 用户列表（管理员）
    @GetMapping("/list")
    public Result<List<Map<String, Object>>> list(@RequestAttribute("role") String role) {
