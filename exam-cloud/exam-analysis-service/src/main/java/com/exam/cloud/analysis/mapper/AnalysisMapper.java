package com.exam.cloud.analysis.mapper;
...
/**
 * 分析服务只读 Mapper，跨表 JOIN 在共享库上完成（reporting/CQRS 风格）。
 */
@Mapper
public interface AnalysisMapper {
    ...
    /** 学生个人成绩趋势（按试卷分组，从 score 表读，避免跨服务依赖） */
    @Select("""
    ...
    """)
    List<Map<String, Object>> studentTrend(@Param("userId") Long userId);
}
